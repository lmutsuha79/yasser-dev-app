...
import PageStrecture from "../components/page-strecture";
import Styles from '../styles/pageStrecture.module.css'

export default function PrivacyPolicy() {
  return (
    <PageStrecture title={"privacy-policy"}>
      <div className={"my-20" + " " + Styles.main}>
        <h1 className="text-2xl text-main-blue font-bold text-center">
          Privacy Policy for Yasser-Mitsuha-Blog
        </h1>

        <div className="text-black font-normal mt-4">
          <p>
            At yasser mitsuha blog, accessible from
            <Link href={"/"}>
              <a className="font-medium text-main-blue-hover ">
                {" https://yasser-dev-app.vercel.app/ "}
              </a>
            </Link>{" "}
            one of our main priorities is the privacy of our visitors. This
            Privacy Policy document contains types of information that is
            collected and recorded by yasser mitsuha blog and how we use it.
          </p>
          ...
          <p>
            ...
            that they shared and/or collect in yasser mitsuha blog. This policy
          ...
          <p>
            yasser mitsuha blog follows a standard procedure of using log files.
          ...
          <p>
            Like any other website, yasser mitsuha blog uses
          ...
          <p>
            ...
            advertising partners of yasser mitsuha blog.
          </p>
          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on yasser mitsuha
            blog, which are sent directly to users&apos; browser. They
          ...
          <p>
            Note that yasser mitsuha blog has no access to or control over these
          ...
          <p>
            yasser mitsuha blog&apos;s Privacy Policy does not apply to other
          ...
          <p>
            yasser mitsuha blog does not knowingly collect any Personal
