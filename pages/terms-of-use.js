...
const TermsOfUse = () => {
  return (
    <PageStrecture title={"Terms of Use"}>
      <div className={"my-20" + " " + Styles.main}>
        <h1 className="text-2xl text-main-blue font-bold text-center">Website Terms of Use</h1>

        <p className="text-center text-main-blue-hover">Version 1.0</p>

        <p>
          The yasser mitsuha blog website located at
          https://yasser-dev-app.vercel.app/ is a copyrighted work belonging to
          yasser mitsuha. Certain features of the Site may be subject to
        ...
        <p>
          ...
          yasser mitsuha blog uses ‘cookies’. These cookies are used to store
        ...
        <p>
          ...
          the Company should be sent to: online. After the Notice is received,
...
<p>Address: online</p>
<p>Email: khelilyasser79@gmail.com</p>
      </div>
    </PageStrecture>
  );
};
